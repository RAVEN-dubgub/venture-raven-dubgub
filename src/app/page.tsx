...
import { FOUNDER_DISPLAY_NAME, LEARNING_APP_URL, SITE_NAME } from "@/lib/venture";
    ...
    <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6">
      ...
      <section className="grid gap-4 md:grid-cols-3">
        ...
        <article className="card">
          ...
          <p className="mt-2 text-sm text-[var(--muted)]">
            Built on {FOUNDER_DISPLAY_NAME}&apos;s cohort stack (PM, comms, showcase, learning app). Venture metrics
