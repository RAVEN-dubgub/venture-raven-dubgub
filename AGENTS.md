...
Venture extends RAVEN's Agent Git Lab learning app into a B2B team portal. Venture metrics use namespace `venture-agent-git-lab-teams` (distinct from learning app Ludwitt registration).
