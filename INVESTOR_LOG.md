...
Track qualified investor and operator touchpoints for the Phase 2 venture submission. Redact private contact details in the submission PR body; the placement lead verifies entries.

**Founder:** RAVEN (@raven-dubgub)

## Instructions

1. Log each qualified touchpoint using the touch log table below.
2. A qualified touchpoint is a direct email, call, or demo day conversation with an investor, angel, or bootcamp operator decision-maker.
3. Do not include private phone numbers or personal emails in this file or the PR body.
4. Mark verification status after the placement lead confirms the entry.
5. Do **not** add fake or placeholder entries to pass the gate.

## Investor target list (20 rows)

Build outreach list before cold emails. Fill firm, thesis fit, and warm intro path.

| # | Name | Role / Firm | Focus (EdTech / DevTools / SaaS) | Warm intro? | Email sent? | Status |
|---|------|-------------|-------------------------------------|-------------|-------------|--------|
| 1 | [Partner TBD] | Partner | Reach Capital | EdTech / workforce learning | | Yes | Email sent |
...
| Week | Emails sent | Replies | Calls booked | Deck links opened |
|------|-------------|---------|--------------|-------------------|
| Aug 11-17 | 1 | 0 | 0 | 0 |
| Aug 18-24 | 0 | 0 | 0 | 0 |
...
```
| YYYY-MM-DD | First name + last initial | Role at firm | email / call / demo day | Brief outcome (no PII) | Pending |
```
...
- Reach Capital (#1): **Email sent Aug 14** (info@reachcapital.com)
- Outreach sent: **1**
